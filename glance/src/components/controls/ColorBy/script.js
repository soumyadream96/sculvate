  ...
  methods: {
    ...
    update() {
      ...
      if (myRepresentations.length) {
        ...
        if (repSliceX) {
          this.colorToSlices = repSliceX.getUseColorByForColor() ?? true;
          this.opacityToSlices = repSliceX.getUseColorByForOpacity() ?? false;
      ...
      this.colorToSlices = true;
      this.applyColorToSlices(true);
    },
