            ...
            <div className="w-1/2">
              <div className=" mb-12">
                ...
                <p className=" text-xl text-gray-600">
                  ...
                  Our team of experienced engineers is here to help with a free
                  consultation.
                </p>
              </div>
              ...
              <form className="flex flex-col space-y-6">
                ...
                <div className="flex items-start">
                  <div className="accent-primary-600 flex items-center h-5">
                    <input
                      id="remember"
                      type="checkbox"
                      value=""
                ...
                <button className="mt-8 w-full h-12 bg-primary-600 hover:bg-primary-700 active:bg-primary-800 hover:transition duration-150 shadow-xs hover:shadow-primary-600/50 rounded-lg text-md font-semibold text-white">
                  Send message
                </button>
              </form>
            </div>
