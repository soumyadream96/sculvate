...
const setPerspectiveView = (
  ...
  camera.target = new BABYLON.Vector3(
    (combinedBoundingBox.minimumWorld.x + combinedBoundingBox.maximumWorld.x) /
      2,
    (combinedBoundingBox.minimumWorld.y + combinedBoundingBox.maximumWorld.y) /
      2,
    (combinedBoundingBox.minimumWorld.z + combinedBoundingBox.maximumWorld.z) /
      2
  );
  camera.mode = BABYLON.Camera.PERSPECTIVE_CAMERA;
  camera.alpha = Math.PI / 3.5;
  camera.beta = Math.PI / 2.7;
  camera.radius = (maxDimension + 2) * 1.5;
};
...
const handleChangeView = (
  ...
  meshes = meshes.filter((mesh: any) => {
    // Check if the mesh is neither null nor undefined before trying to access its properties
    return mesh != null && mesh._lineMaterial === undefined;
  });
...
const MeshTab = ({ mainScene }: MeshTabProps) => {
  ...
  useEffect(() => {
    ...
    hideMeshes("Distance ", mainScene);
    hideMeshes("TextPlane", mainScene);
    hideMeshes("_ground", mainScene);
  }, [mainScene, models]);
  useEffect(() => {
    return () => {
      ...
      <div className="text-center border-r border-[#EAECF0] pr-3 ">
        <div className="flex w-max min-[1540px]:w-auto">
          ...
          <button
            ...
            className={`text-[#344054] my-auto enabled:shadow-sm px-3 py-1.5 font-medium border border-[#D0D5DD] text-sm flex items-center justify-center rounded-bl-md rounded-tl-md focus:outline-none bg-green-50 enabled:hover:bg-[#D9E8DD] enabled:active:bg-[#C5D6C8] disabled:opacity-50`}
          ...
          <button
            ...
            className={`text-[#344054] my-auto enabled:shadow-sm px-3 py-1.5 font-medium border border-[#D0D5DD] text-sm flex items-center justify-center focus:outline-none border-l-0 bg-green-50 enabled:hover:bg-[#D9E8DD] enabled:active:bg-[#C5D6C8] disabled:opacity-50`}
            disabled={!meshDefined}
          >
            <svg
              className="mr-2 w-5 h-5"
          ...
          <button
            ...
            className={`text-[#344054] my-auto enabled:shadow-sm px-3 py-1.5 font-medium border border-l-0 border-[#D0D5DD] text-sm flex items-center justify-center rounded-tr-md rounded-br-md focus:outline-none bg-green-50 enabled:hover:bg-[#D9E8DD] enabled:active:bg-[#C5D6C8] disabled:opacity-50`}
            disabled={!meshDefined}
          >
            <svg
              className="mr-2 w-5 h-5"
      ...
      <div className="text-center">
        <div className="flex w-max min-[1540px]:w-auto">
          <button
            ...
            className={`text-[#344054] my-auto enabled:shadow-sm px-3 py-1.5 font-medium border border-[#D0D5DD] text-sm flex items-center justify-center rounded-md focus:outline-none bg-[#FEFBE8] enabled:hover:bg-[#E3E2C3] enabled:active:bg-[#C8C9A8] disabled:opacity-50`}
            disabled={
      ...
      <div className="text-center">
        <div className="flex w-max min-[1540px]:w-auto">
          ...
          <button
            ...
            className={`text-[#344054] my-auto enabled:shadow-sm px-3 py-1.5 font-medium border border-[#D0D5DD] text-sm flex items-center justify-center rounded-bl-md rounded-tl-md focus:outline-none bg-[#EEF4FF] enabled:hover:bg-[#D3E2EF] enabled:active:bg-[#B1C7DE] disabled:opacity-50`}
            disabled={
              !arrayModel.some((dict) =>
                Object.values(dict).includes("Objects")
              )
          ...
          <button
            ...
            className={`text-[#344054] my-auto enabled:shadow-sm px-3 py-1.5 font-medium border border-[#D0D5DD] text-sm flex items-center justify-center rounded-tr-md rounded-br-md focus:outline-none border-l-0 bg-[#EEF4FF] enabled:hover:bg-[#D3E2EF] enabled:active:bg-[#B1C7DE] disabled:opacity-50`}
            disabled={
              !arrayModel.some((dict) =>
                Object.values(dict).includes("Objects")
              )
      ...
      <div className="text-center">
        <div className="flex w-max min-[1540px]:w-auto">
          ...
          <button
            ...
            className={`text-[#344054] my-auto enabled:shadow-sm px-3 py-1.5 font-medium border border-[#D0D5DD] text-sm flex items-center justify-center rounded-bl-md rounded-tl-md focus:outline-none bg-[#FFF1F3] enabled:hover:bg-[#EDD0D4] enabled:active:bg-[#E0AFB5] disabled:opacity-50`}
            disabled={
              !arrayModel.some((dict) =>
                Object.values(dict).includes("Objects")
              )
          ...
          <button
            ...
            className={`text-[#344054] my-auto enabled:shadow-sm px-3 py-1.5 font-medium border border-[#D0D5DD] text-sm flex items-center justify-center rounded-tr-md rounded-br-md focus:outline-none border-l-0 bg-[#FFF1F3] enabled:hover:bg-[#EDD0D4] enabled:active:bg-[#E0AFB5] disabled:opacity-50`}
            disabled={
              !arrayModel.some((dict) =>
                Object.values(dict).includes("Objects")
              )
      ...
      <div className="text-center">
        <div className="flex w-max min-[1540px]:w-auto">
          ...
          <button
            ...
            className={`text-[#344054] my-auto enabled:shadow-sm px-3 py-1.5 font-medium border border-[#D0D5DD] text-sm flex items-center justify-center rounded-bl-md rounded-tl-md focus:outline-none bg-[#F3FEE7] enabled:hover:bg-[#E2EFD4] enabled:active:bg-[#BFCDB0] disabled:opacity-50 `}
            disabled={
              !arrayModel.some((dict) =>
                Object.values(dict).includes("Objects")
              )
          ...
          <button
            ...
            className={`text-[#344054] my-auto enabled:shadow-sm px-3 py-1.5 font-medium border border-[#D0D5DD] text-sm flex items-center justify-center rounded-tr-md rounded-br-md focus:outline-none border-l-0 bg-[#F3FEE7] enabled:hover:bg-[#E2EFD4] enabled:active:bg-[#BFCDB0] disabled:opacity-50`}
            disabled={
              !arrayModel.some((dict) =>
                Object.values(dict).includes("Objects")
              )
